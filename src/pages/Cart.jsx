        ...
        <div className="cart-wrap">
          <div className="cart-title">
            <div className="cart-goods-info">
              <input type="checkbox" checked={checkedItems.length === cartItems.length} onChange={handleAllChecked} />
              상품정보
            </div>
            ...
            <ul className="cart-list">
              {cartItems.map((item)=>(
                <li key={`${item.id}-${item.size}`}>
                  <div className="cart-goods-info">
                    <input type='checkbox' checked={checkedItems.includes(`${item.id}-${item.size}`)} onChange={() => handleChecked(item)} />
